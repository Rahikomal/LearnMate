    ...
    <PageTransition>
      <div className="min-h-[calc(100vh-4rem)] relative">
        <div className="container-custom py-[1.5rem] md:py-[3.25rem]">
          {/* Navigation / Header */}
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-[1.5rem] mb-[1.75rem]">
          ...
          <motion.div
            ...
            className="glass-premium !p-[2rem] sm:!p-[3.25rem] mb-[1.75rem] overflow-hidden relative border-primary/20 shadow-2xl"
          >
            ...
            <div className="relative z-10 flex flex-col items-center text-center max-w-[45rem] mx-auto">
              <div className="w-[5rem] h-[5rem] rounded-[1.5rem] gradient-primary flex items-center justify-center text-white font-black text-[2.5rem] shadow-glow mb-[1.5rem] transform rotate-3 ring-[0.25rem] ring-background">
              ...
              <div className="flex flex-wrap justify-center gap-[0.75rem] mb-[1.25rem]">
          ...
          <div className="flex flex-col md:flex-row gap-[1.75rem]">
            {/* Feed Column */}
            <div className="flex-1 space-y-[1.25rem]">
              {/* Post Composer */}
              <motion.div
                initial={{ opacity: 0, scale: 0.98 }}
                animate={{ opacity: 1, scale: 1 }}
                transition={{ delay: 0.2 }}
                className="glass-premium !p-[1.25rem] border-primary/10 shadow-lg"
              >
                <div className="flex items-center gap-[0.5rem] text-primary font-black uppercase tracking-[0.1em] mb-[1rem] text-[0.75rem]">
                ...
                <Textarea 
                  ...
                  className="rounded-[1.25rem] bg-secondary/20 border-border/40 min-h-[7rem] resize-none focus-visible:ring-primary/20 transition-all p-[1.25rem] font-medium leading-relaxed"
                />
            ...
            {/* Members Sidebar */}
            <aside className="w-full md:w-[20rem]">
              <div className="sticky top-[6rem] flex flex-col gap-[1.5rem]">
                {/* Contributors Widget */}
                <div className="glass-premium !p-[1.5rem] !rounded-[2.5rem] shadow-xl">
                    ...
                    {[...Array(5)].map((_, i) => {
                      ...
                      return (
                        <motion.div
                          ...
                          className="flex items-center gap-[0.75rem] p-[0.375rem] hover:bg-primary/5 rounded-[1.25rem] transition-all cursor-pointer border border-transparent hover:border-primary/10 group"
                        >
                          <div className={`w-[2.5rem] h-[2.5rem] rounded-[1rem] ${colors[i]} flex items-center justify-center text-white font-black text-[0.875rem] shadow-sm transform-gpu transition-transform group-hover:scale-105`}>
                            {initials}
                          </div>

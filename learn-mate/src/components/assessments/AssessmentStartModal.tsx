      ...
      <DialogContent className="sm:max-w-md rounded-[1.5rem] p-6 md:p-8 bg-white border-slate-200">
        ...
        <div className="grid grid-cols-2 gap-3 mt-6">
           <div className="p-4 rounded-[1.25rem] bg-slate-50 border border-slate-100 space-y-1.5 group hover:border-primary/20 transition-all">
              ...
              <p className="text-xl font-black text-slate-900">10 Mins</p>
           </div>
           <div className="p-4 rounded-[1.25rem] bg-slate-50 border border-slate-100 space-y-1.5 group hover:border-primary/20 transition-all">
              <div className="flex items-center gap-1.5 text-slate-400">
              ...
              <p className="text-xl font-black text-slate-900">{questionCount} Qs</p>
           </div>
        </div>

        <div className="mt-6 p-3.5 rounded-xl bg-amber-50 border border-amber-100 flex gap-3 items-center">
        ...
        <DialogFooter className="mt-8 sm:justify-start gap-3">
          <Button variant="ghost" onClick={onClose} className="rounded-xl h-12 px-6 font-black text-[11px] uppercase tracking-widest text-slate-400 hover:text-slate-600 hover:bg-slate-50 transition-colors">
            Cancel
          </Button>
          <Button 
            disabled={isStarting}
